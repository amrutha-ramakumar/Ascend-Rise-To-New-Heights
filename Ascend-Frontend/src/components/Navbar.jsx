        ...
        <div className="flex items-center space-x-6">
          {isAuthenticated ? (
            <>
              ...
              {userRole === "admin" && (
  <>
    <Link to="/admin/jobseeker-list" className="hover:text-blue-500">
      Jobseeker List
    </Link>
    <Link to="/admin/employer-list" className="hover:text-blue-500">
      Employer List
    </Link>
    <Link to="/admin/employer-verification" className="hover:text-blue-500">
      Verify Employers
    </Link>
    <Link to="/admin/subscription-plans" className="hover:text-blue-500">
      Subscription List
    </Link>
  </>
)}
