    ...
    <div className="min-h-screen bg-gray-50 p-6 pt-20">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl overflow-hidden">
        <div className="bg-blue-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">{job.position}</h1>
            <div className="bg-blue-500 text-sm px-3 py-1 rounded-full">{job.applicationStatus}</div>
          </div>
          <div className="mt-2 flex items-center">
            <BuildingOfficeIcon className="h-5 w-5 mr-2" />
            <span className="text-xl">{job.company}</span>
            {chat ? (
              <button
                ...
                className="text-xl px-2 text-white hover:text-blue-200 transition-colors"
              >
                <ChatBubbleLeftIcon className="h-5 w-5 mr-2" />
              </button>
            ) : (
